        ...
        <div class="login-form">
            ...
            <div class="sign-up-htm">
                ...
                <div class="group">
                    ...
                    <input type="password" class="input" id="member_pwdTwo" placeholder="passwordCheck"
                           required="required">
                ...
                <div class="group">
                    ...
                    <br>
                    <input type="button" class="button" onclick="searchPost()" style="cursor: pointer"
                           value="우편번호 찾기"><br>
                    <input type="text" name="member_faddr" id="member_faddr" class="input" size="50" readonly><br>
                    <input type="text" name="member_laddr" id="member_laddr" class="input" size="50"
